  ...
  return (
    <div className="container-fluid user-dashboard py-4">
      ...
      <div className="dashboard-section">
        ...
        {purchasedPlans.length === 0 ? (
          <div className="empty-state">
            ...
            <button className="continue-btn" style={{ maxWidth: 220, margin: "16px auto 0" }} onClick={() => navigate("/purchase-plan")}>
      ...
      <div className="dashboard-section mt-4">
        ...
        <button className="continue-btn" style={{ maxWidth: 220 }} onClick={() => navigate("/courses")}>
